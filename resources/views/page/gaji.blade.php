...
<div class="m-subheader ">
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title m-subheader__title--separator">Gaji Karyawan</h3>
            <ul class="m-subheader__breadcrumbs m-nav m-nav--inline">
                ...
                <li class="m-nav__item">
                    <a href="" class="m-nav__link">
                        <span class="m-nav__link-text">Gaji Karyawan</span>
                    </a>
                </li>
            </ul>
        </div>
        ...
        <div class="m-portlet__head-caption">
            <div class="m-portlet__head-title">
                <h3 class="m-portlet__head-text">
                    Manage Data Gaji Karyawan<p id="hax"></p>
                </h3>
            </div>
        </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group m-form__group row" >
                        <label class="col-form-label col-md-3" style="text-align:left">
                            ...
                            <div class="col-md-6">
                            <input type="number" name="jumlah" required class="form-control m-input" placeholder="Rp."/>
                        </div>
                    </div>
                    <div class="form-group m-form__group row">
                        <label class="col-form-label col-md-3" style="text-align:left">
                        ...
                        <div class="col-md-6">
                            <input type="date" id="meeting-time" class="form-control m-input" name="tanggal"/>
                        </div>
                    </div>
                    <div class="form-group m-form__group row spkadd">
                        <label class="col-form-label col-md-3" style="text-align:left">
    ...
    function edit(id) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.data) {
                    $('#formAdd')[0].reset();
                    $('[name="gaji_id"]').val(data.data.gaji_id);
                    $('[name="karyawan_id"] option[value="' + data.data.karyawan_id + '"]').attr('selected', 'selected');
